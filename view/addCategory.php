            ...
            <div class="col-xl-6 col-lg-6 col-md-12">
              ...
              <form action="../Controller/CategoryController.php" method="POST" class="tm-edit-product-form">
                ...
                <div class="form-group mb-3">
                  ...
                  <input id="CategoryName" name="CategoryName" type="text" class="form-control validate" required />
                </div>
                
                <div class="col-12">
                  <button type="submit" value="add" class="btn btn-primary btn-block text-uppercase">Add Category Now</button>
                </div>
              </form>
